...
<div class="main-wrapper">
    ...
    <div id="slider-holder">
        ...
        <div id="sliderImages">
            ...
            <img id="si_2" src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/2.jpg" alt="" />
            <img id="si_3" src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/3-3.jpg" alt="" />
            <img id="si_4" src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/5.jpg" alt="" />
    ...
    <section class="about-section">
        ...
        <div class="about-wrapper">
            ...
            <div class="section-header about-header">
                <h2>About US</h2>
                <h4>Cosmos Tours your Trips Counselor</h4>
            </div>
